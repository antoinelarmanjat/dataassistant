...
let PieChartView = (() => {
    let _classDecorators = [customElement('a2ui-pie-chart')];
    ...
    var PieChartView = class extends _classSuper {
        ...
        constructor() {
            ...
            this.chart = (__runInitializers(this, _colors_extraInitializers), null);
        }
        static {
            ...
            PieChartView = _classThis = _classDescriptor.value;
    ...
    `;
        ...
        renderChart() {
            ...
            if (!labels.length || !values.length)
                return;
            const canvas = this.renderRoot.querySelector('#pieCanvas');
            if (!canvas)
                return;
    ...
    return PieChartView = _classThis;
})();
export { PieChartView };
